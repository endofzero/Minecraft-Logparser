...
function displayStats()
{
	...
	$queryUsers = "SELECT distinct player, count(*) as count from playerachievements group by player";
...
$query = "SELECT * from playerachievements order by player,lastupdate,count,achievement";
...
array_push($masterOutput, "<tr><td>".$row["player"]."</td><td>". htmlspecialchars(trim($row["achievement"]))."</td><td>".$row["count"]."</td><td>".$row["lastupdate"]."</td></tr>");
